...
INSERT INTO
        `Account` (AccountID, FirstName, LastName, Email, Password, RegisterDate, LoginTime)
VALUES
        (
                'A001',
                'Warawuth',
...
VALUES
        ('IMG-K1-01', '/images/products/k1_pro_1.png'),
...
INSERT INTO
        `Stocks` (StockID, Color, Amount)
VALUES
        ('STK-K1-BLK', 'Black', 150),
        ('STK-Q1-WHT', 'White', 45),
...
INSERT INTO
        `Manage` (ManageID, ManageTime, ManageAction, AccountID, SKU)
VALUES
        ('MNG-001', '2026-02-20', 'CREATE', 'A001', 'K1-PRO-RED'),
